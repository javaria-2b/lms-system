...
const student1 = new Student("jia@1", "jia", "Javaria Shaukat", 14, "female")
const student2 = new Student("mjs", "js", "Muhammad", 21, "male")
...
export let studentsData: Student[] = [student1, student2];
export let courseData: Course[] = [course1, course2, course3, course4, course5];
export let instructorsData: Instructor[] = [instructor1, instructor2]
